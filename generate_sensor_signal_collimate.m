function [return_signal] = generate_sensor_signal_collimate(resolution, downsample_ratio, offset, shift_vector, depth_map, T_0)
...
%   The intensity of return signal follows inverse square rule
    ...
    % sub-pixel shift
    depth_map(isinf(depth_map)) = farfield_thres; % remove Inf values for imtranslate to work
